...
export const metadata: Metadata = {
  ...
  keywords: "해수욕장 개장일, 수영장 개장일, 수영장 운영기간, 수영장 운영시간, 수영장 이용료, 수영장 가격, 여름 휴가, 여름 피서, 취사가능 계곡, 무료 물놀이터, 바닥분수, 씨맵(Sea-Map), 여름 여행지 추천, 전국 물놀이 지도, 가성비 수영장, 워터파크 할인, 부산 해수욕장, 제주도 해수욕장, 동해안 해수욕장, 여름 방학 가볼만한곳, 아이와 가볼만한곳, 무료 수영장",
  openGraph: {
